...
export async function fetchDashboardData(): Promise<DashboardData> {
  ...
  try {
    ...
    const totalCapacity = channels.reduce(
      (sum: number, channel: RustChannelInfo) => {
        try {
    ...
    const averageChannelCapacity =
      totalChannels > 0 ? totalCapacity / totalChannels : 0;
    ...
    channels.forEach((channel: RustChannelInfo) => {
      try {
        ...
        if (
          node1Country &&
          node1Country !== "Unknown" &&
          countryMap.has(node1Country)
        ) {
          countryMap.get(node1Country)!.capacity += capacityInCKB / 2;
        }
        if (
          node2Country &&
          node2Country !== "Unknown" &&
          countryMap.has(node2Country)
        ) {
    ...
    geoNodes: [
      {
        ...
        countryCode: "US",
        nodeCount: 3241,
        totalCapacity: 234050.5,
      },
      {
        country: "Germany",
        countryCode: "DE",
        nodeCount: 2156,
        totalCapacity: 189020.2,
      },
      {
        country: "Netherlands",
        countryCode: "NL",
        nodeCount: 1892,
        totalCapacity: 156780.8,
      },
      {
        country: "United Kingdom",
        countryCode: "GB",
        nodeCount: 1654,
        totalCapacity: 134560.6,
      },
      {
        country: "Canada",
        countryCode: "CA",
        nodeCount: 1432,
        totalCapacity: 112340.4,
      },
      {
        country: "France",
        countryCode: "FR",
        nodeCount: 1234,
        totalCapacity: 98760.6,
      },
      {
        country: "Japan",
        countryCode: "JP",
        nodeCount: 1156,
        totalCapacity: 87650.5,
      },
      {
        country: "Australia",
        countryCode: "AU",
        nodeCount: 987,
        totalCapacity: 76540.4,
      },
      {
        country: "Switzerland",
        countryCode: "CH",
        nodeCount: 876,
        totalCapacity: 65430.3,
      },
      {
        country: "Singapore",
        countryCode: "SG",
        nodeCount: 765,
        totalCapacity: 54320.2,
      },
    ],
    ispRankings: [
      {
        isp: "Cloudflare",
        nodeCount: 2341,
        totalCapacity: 189050.5,
        averageCapacity: 80.8,
      },
      {
        isp: "DigitalOcean",
        nodeCount: 2156,
        totalCapacity: 167890.9,
        averageCapacity: 77.8,
      },
      {
        isp: "AWS",
        nodeCount: 1987,
        totalCapacity: 145670.7,
        averageCapacity: 73.3,
      },
      {
        isp: "OVH",
        nodeCount: 1765,
        totalCapacity: 123450.5,
        averageCapacity: 69.9,
      },
      {
        isp: "Hetzner",
        nodeCount: 1543,
      ...
      },
      {
        ...
        nodeCount: 1321,
        totalCapacity: 98760.6,
        averageCapacity: 74.8,
      },
      {
        isp: "Vultr",
        nodeCount: 1198,
        totalCapacity: 87650.5,
        averageCapacity: 73.2,
      },
      {
        isp: "Google Cloud",
        nodeCount: 1087,
        totalCapacity: 76540.4,
        averageCapacity: 70.4,
      },
      {
        isp: "Azure",
        nodeCount: 976,
        totalCapacity: 65430.3,
        averageCapacity: 67.0,
      },
      {
        isp: "Scaleway",
        nodeCount: 865,
        totalCapacity: 54320.2,
        averageCapacity: 62.8,
      },
    ],
  };
};
...
// 获取时间序列数据
export async function fetchTimeSeriesData(): Promise<
...
// 获取 ISP 排行榜数据
export async function fetchIspRankingData(): Promise<
  DashboardData["ispRankings"]
> {
  const data = await fetchDashboardData();
